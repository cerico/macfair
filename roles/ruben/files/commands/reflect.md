...
1. **Check processed entries log**:
   - Read `~/.claude/ruben/memory/reflections/processed.log` to find already-processed diary entries
   ...
   - Create the file if it doesn't exist: `touch ~/.claude/ruben/memory/reflections/processed.log`

2. **Locate diary entries**:
   - Directory: `~/.claude/ruben/memory/diary/`
...
5. **Create the reflections directory** (if it doesn't exist):
   - Directory: `~/.claude/ruben/memory/reflections/`
...
10. **Save the reflection document**:
   ...
   - Save to: `~/.claude/ruben/memory/reflections/[filename]`
...
12. **Update processed entries log**:
   - Append processed diary entries to `~/.claude/ruben/memory/reflections/processed.log`
...
**Default behavior**: Skip entries already listed in `~/.claude/ruben/memory/reflections/processed.log`
