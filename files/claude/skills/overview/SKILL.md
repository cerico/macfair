...
user-invocable: true
argument: author to exclude (optional, e.g. "dependabot")
---
...
- Exclude `chore(release)` commits (automated version bumps)
...
- Exclude `chore(release)` and any user-specified authors
